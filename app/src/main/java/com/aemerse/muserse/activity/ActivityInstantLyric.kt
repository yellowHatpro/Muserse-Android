...
import com.aemerse.muserse.qlyrics.lyrics.ViewLyrics.fromMetaData
import com.aemerse.muserse.qlyrics.offlineStorage.OfflineStorageArtistBio.getArtistInfoFromCache
import com.aemerse.muserse.qlyrics.offlineStorage.OfflineStorageArtistBio.putArtistInfoToCache
import com.aemerse.muserse.qlyrics.offlineStorage.OfflineStorageLyrics.clearLyricsFromDB
import com.aemerse.muserse.qlyrics.offlineStorage.OfflineStorageLyrics.getInstantLyricsFromDB
import com.aemerse.muserse.qlyrics.offlineStorage.OfflineStorageLyrics.getLyricsFromCache
import com.aemerse.muserse.qlyrics.offlineStorage.OfflineStorageLyrics.isLyricsPresentInDB
import com.aemerse.muserse.qlyrics.offlineStorage.OfflineStorageLyrics.putInstantLyricsInDB
import com.aemerse.muserse.qlyrics.offlineStorage.OfflineStorageLyrics.putLyricsToCache
...
import com.aemerse.muserse.utils.AppLaunchCountManager.instantLyricsLaunched
...
class ActivityInstantLyric : AppCompatActivity(), OnItemTouchListener, Lyrics.Callback,
    ...
    private inner class SetBlurryImagetask :
        ...
        override fun doInBackground(vararg p0: ArtistInfo?): Bitmap? {
            ...
            val CACHE_ART_THUMBS = ApplicationClass.getContext().cacheDir.toString() + "/art_thumbs/"
