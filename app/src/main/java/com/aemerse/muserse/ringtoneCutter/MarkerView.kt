 ...
 */
class MarkerView constructor(context: Context?, attrs: AttributeSet?) : androidx.appcompat.widget.AppCompatImageView(context!!, attrs) {
    ...
    override fun onKeyDown(keyCode: Int, event: KeyEvent): Boolean {
        mVelocity++
        val v: Int = Math.sqrt((1 + mVelocity / 2).toDouble()).toInt()
        if (mListener != null) {
