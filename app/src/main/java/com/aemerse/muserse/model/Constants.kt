...
object Constants {
    ...
    interface ACTION {
        companion object {
            const val MAIN_ACTION = "com.aemerse.muserse.action.main"
            const val FAV_ACTION = "com.aemerse.fav"
            const val PREV_ACTION = "ccom.aemerse.muserse.action.prev"
            const val PLAY_PAUSE_ACTION = "com.aemerse.muserse.action.play"
            const val NEXT_ACTION = "com.aemerse.muserse.action.next"
            const val DISMISS_EVENT = "com.aemerse.muserse.action.dismiss"
            const val SWIPE_TO_DISMISS = "com.aemerse.muserse.action.swipe.to.dismiss"
            const val COMPLETE_UI_UPDATE = "UPDATE_NOW_PLAYING"
            const val DELETE_RESULT = "delete"
            const val OPEN_FROM_FILE_EXPLORER = "com.aemerse.muserse.action.explorer"
